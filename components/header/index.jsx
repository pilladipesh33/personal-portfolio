    ...
    <div className="w-full h-[5dvh] flex justify-between items-center border border-white border-b-black">
      ...
      <div className="flex justify-between items-center w-full md:w-1/4">
        <Link href={"/"} className="uppercase">
          <h1 className="hover:text-active hover:font-medium hover:animate-bounce">Index</h1>
        </Link>
        <Link href={"/projects"} className="uppercase">
        <h1 className="hover:text-active hover:font-medium hover:animate-bounce">Work</h1>
        </Link>
        <Link href={"/contact"} className="uppercase">
        <h1 className="hover:text-active hover:font-medium hover:animate-bounce">Contact</h1>
        </Link>
      </div>
    </div>
  );
